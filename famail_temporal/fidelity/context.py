...
class MultiStreamContextBuilder:
    ...
    def __init__(
        ...
        """
        Args:
            multi_stream_data: Bundle of driving/seeking/profile data per driver.
    ...
    def build_fidelity_kwargs(
        ...
        # Decision 3: +1 to x,y for coordinate system alignment
    ...
    def _build_seeking_with_context(
        ...
        Decision 2: Slot 0 = target trajectory, slots 1..N-1 = random context
        from same driver.
        Decision 4: Only slot 0 of x2 maintains gradient flow; context is detached.
        ...
        # Context is detached (no gradients) -- Decision 4
        all_trajs = torch.cat(
    ...
    def _trajectory_to_1indexed(self, trajectory: "Trajectory") -> torch.Tensor:
        ...
        Decision 3: The modifier uses 0-indexed grid coords [0-47, 0-89].
        V3 was trained on 1-indexed [1-48, 1-90].
        We add +1 to x and y coordinates.
        """
        from famail_temporal.utils.trajectory import Trajectory  # noqa: F811
