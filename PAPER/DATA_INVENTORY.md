...
| `shz_hgc_a10_channel_decomposition.json` | `2026-07-13T04-41-12_..._hgc_filtered/channel_decomposition.json` | §4.6 lift-up CI: total +0.0594 [+0.0181,+0.1013]; supply +0.0054 sig; **demand +0.0539 sig (unlike PRIMARY, where demand is n.s.)** (A1 run 2026-07-16, B=2000) |
...
| `shz_4feat_a10_channel_decomposition.json` | `2026-07-13T17-04-22_..._4feat_filtered/channel_decomposition.json` | §4.6 lift-up CI: total +0.1461 [+0.0900,+0.2039]; supply +0.0608 sig; demand +0.0853 sig — the demand channel explains the 2.8× PRIMARY total (A1 run 2026-07-16, B=2000) |
