...
under bounded edits. A full
$(\Delta F_{\mathrm{spatial}}, \Delta F_{\mathrm{causal}})$ Pareto sweep over
the weight simplex is reported as a sensitivity analysis around the adopted
point (\S\ref{sec:experiments}).
